...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.play_hard_button = Button(self, "Play Hard", y_offset=60)

        # 暂停菜单按钮
        self.resume_button = Button(self, "Resume Game", y_offset=-60)
        self.menu_button = Button(self, "Back to Menu", y_offset=0)
        self.exit_button = Button(self, "Exit Game", y_offset=60)
    ...
    def _check_play_button(self, mouse_pos):
        ...
        hard_clicked = self.play_hard_button.rect.collidepoint(mouse_pos)
    ...
    def _check_pause_menu(self, mouse_pos):
        """处理暂停菜单按钮点击"""
        resume_clicked = self.resume_button.rect.collidepoint(mouse_pos)
    ...
    def _update_screen(self):
        ...
        if not self.game_active:
            ...
            self.play_hard_button.draw_button()
        elif self.game_paused:
            # 暂停菜单
